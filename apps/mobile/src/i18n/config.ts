...
const resources = {
  en: {
    translation: {
      ...
      addIncomePlaceholder: 'Income entry will be built in the records epic. This placeholder confirms the dashboard route works.',
  ...
  tr: {
    translation: {
      ...
      addIncomePlaceholder: 'Gelir girişi records epic içinde geliştirilecek. Bu yer tutucu dashboard rotasının çalıştığını doğrular.',
